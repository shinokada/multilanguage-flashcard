  ...
  >
    <div class="flip-box-inner" class:flip-it={showCardBack}>
      <div class="relative h-full">
        <div
          class="absolute inset-0 flex flex-col items-center items-center justify-center bg-red-700 p-4 text-gray-200"
        >
        ...
        <div
          class="absolute inset-0 flex flex-col items-center justify-center bg-blue-700 p-4 text-gray-200 opacity-0 {showCardBack
